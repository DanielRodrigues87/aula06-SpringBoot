package br.com.daniel.aula06.controller;
...
import br.com.daniel.aula06.dto.TarefaDTO;
import br.com.daniel.aula06.facade.TarefasFacade;
...
public class TarefasApi {
	...
	@PutMapping("/{tarefaId}")
	@ResponseBody
	public TarefaDTO atualizar(@PathVariable("tarefaId") 
	Long tarefaId, @RequestBody TarefaDTO tarefaDTO) {
	...
	@ResponseBody
	public String deletar(@PathVariable("tarefaId") 
	Long tarefaId) {
